...
fps_min = string(floor(argument0/_frames_in_min))
	
var fps_second_int = floor(argument0/_frames_in_sec) mod 60
...
var fps_milli_int = floor(((argument0*_sec_in_frame) mod 1)*100)
